...
#  Choices: any of ['sha224', 'sha256', 'blake2b', 'sha3_256', 'blake2s', 'md5', 'sha3_512', 'sha512', 'sha384', 'sha3_384', 'sha3_224', 'sha1']
#  Default: 'sha256'
...
c.ServerApp.terminado_settings={'shell_command' : ['/usr/bin/zsh']} # 默认shell
